    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="w-[66px] h-[48px] flex justify-center gap-1.5 mt-5">
                <div className="w-[12px] h-[12px] rounded-full bg-[#005B3F]" onClick={() => setGuidePage(0)}></div>
                <div className="w-[12px] h-[12px] rounded-full bg-[#D9D9D9]" onClick={() => setGuidePage(1)}></div>
                <div className="w-[12px] h-[12px] rounded-full bg-[#D9D9D9]" onClick={() => setGuidePage(2)}></div>
                <div className="w-[12px] h-[12px] rounded-full bg-[#D9D9D9]" onClick={() => setGuidePage(3)}></div>
            </div>
            <div>
